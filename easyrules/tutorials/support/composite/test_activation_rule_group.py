...
from easyrules import RuleDecorator, Fact, Rule, Facts, Rules, DefaultRuleEngine, ActivationRuleGroup
...
unit_rule_group = ActivationRuleGroup(name='a_activation_rule_group', domain='example', priority=1)
