...
from easyrules import RuleDecorator, Fact, Rule, Facts, Rules, DefaultRuleEngine, UnitRuleGroup
...
unit_rule_group = UnitRuleGroup(name='a_unit_rule_group', domain='example', priority=1)
